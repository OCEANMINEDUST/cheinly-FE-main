...
export type Role = "seller" | "buyer" | "supplier";
...
export const notificationsFor = (role: Role): AppNotification[] => {
  ...
  if (role === "supplier") {
    return [
      { id: 1, kind: "order", title: "New supply order SUP-1001", body: "Imported Sneakers x500 • pending dispatch", time: "4m", cta: "Process order", to: "/supplier/orders" },
