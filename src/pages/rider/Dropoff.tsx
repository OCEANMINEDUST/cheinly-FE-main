...
import { ArrowLeft, Lock, MessageCircle, Phone, ShieldCheck } from "lucide-react";
import { motion } from "framer-motion";
import { RiderShell } from "@/components/rider/RiderShell";
import { Button } from "@/components/ui/button";
import { Card, CardContent } from "@/components/ui/card";
import { InputOTP, InputOTPGroup, InputOTPSlot } from "@/components/ui/input-otp";
import { formatNaira, getOrderById, pushHistory, updateOrder } from "@/lib/riderMock";
      ...
      <div className="space-y-4 px-5 py-5">
        ...
        <Card className="border-primary/30 bg-primary/5">
          <CardContent className="space-y-4 p-5 text-center">
            ...
            <div>
              <p className="font-display text-xl text-foreground">Enter delivery code</p>
