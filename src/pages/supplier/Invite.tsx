  ...
  return (
    <SupplierShell>
      <section className="rounded-2xl bg-[linear-gradient(135deg,hsl(210_85%_42%),hsl(220_70%_28%))] p-8 text-white shadow-card">
        ...
        <h1 className="font-display text-4xl">Fulfill a high-priority pending order</h1>
      ...
      <section className="mt-8 grid gap-4 md:grid-cols-4">
        ...
        <Card className="p-4"><PackageCheck className="h-4 w-4 text-primary" /><p className="mt-2 text-sm font-medium">Evidence-led Fulfillment</p></Card>
